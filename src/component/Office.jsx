...
export function Office(props) {
  ...
  const texttureOpacity = useMotionValue(0);
  const glassTexttureOpacity = useMotionValue(0);

  useEffect(() => {
    animate(texttureOpacity, section === 0 ? 1 : 0);
    animate(glassTexttureOpacity, section === 0 ? 0.42 : 0);
  }, [section]);

useFrame(()=>{
  textureMaterial.opacity=texttureOpacity.get()
  glassTexttureOpacity.opacity=glassTexttureOpacity.get()
